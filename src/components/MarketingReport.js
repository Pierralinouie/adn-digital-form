     ...
     {analysisData.summary.platformRecommendations && (
       <section>
         ...
         <div className="space-y-4">
           <div className="bg-gray-50 p-4 rounded-lg">
             <h4 className="font-medium mb-2">Plateformes Principales</h4>
             <div className="flex flex-wrap gap-2">
               {analysisData.summary.platformRecommendations.primary.map((platform, index) => (
           ...
           <div className="bg-gray-50 p-4 rounded-lg">
             <h4 className="font-medium mb-2">Fréquence de Publication</h4>
             <ul className="space-y-2">
               {Object.entries(analysisData.summary.platformRecommendations.posting_frequency).map(([platform, frequency]) => (
